...
## Git Workflow
*   **Branch Names**: Always use meaningful, descriptive branch names for your submissions (e.g., `feature/add-login-tests`, `fix/mobile-nav-bug`). Avoid generic or generated names.
