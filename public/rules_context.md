# LTTA Summer 2025 Rules & Responsibilities
La Crosse Team Tennis Association · Updated April 16, 2025

## Overview
* **League Coordinator**: Brett Meddaugh · 2025 season lead
* **Season Window**: June 3 – August 14 · Tue & Wed nights
* **Match Site**: Green Island Park · 13 outdoor courts
* **Player Fee**: $25 per roster slot · covers balls & courts

## League Coordinator & Governance
...
* Ensure the team is represented at the preseason meeting, even if a delegate must attend in the captain’s place.
...
> USTA Friend at Court rules are the final authority for any unresolved situations.

## League Committee Responsibilities
...
* **#1:** Anticipates well, approaches the net confidently, and can force errors or hit winners. Executes lobs and overheads with above-average success.
* **#2:** Incorporates power and spin, maintains solid footwork, and delivers an above-average first serve. Second serve development is the primary improvement area.
* **#3:** Dependable strokes with a variety of shots (lobs, overheads, approach shots, volleys) and can place serves to create errors.
* **#4:** Stroke variety and depth need improvement. Can direct shots away from opponents but struggles to generate depth on demand. Serve is somewhat consistent and produces limited errors.
* **#5:** Sustains slower-paced rallies with moderate placement. Not yet comfortable with all strokes and lacks serving consistency.