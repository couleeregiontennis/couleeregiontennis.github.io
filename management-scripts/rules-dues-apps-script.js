...
function generatePlainText(team) {
  ...
  if (isTues) {
    ...
    scheduleNoticeText = 
      ...
      "Note: If you imported the team calendar (.ics file) or printed/saved your schedule prior to June 21st, your calendar will show the incorrect match times. Please download the updated calendar (.ics) file below (or check the website) to ensure your schedule is correct.\n\n" +
