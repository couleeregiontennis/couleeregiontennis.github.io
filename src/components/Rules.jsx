...
const overviewCards = [
  {
    ...
    description: 'Brett Meddaugh · 2025 season lead'
  },
  {
    icon: '📅',
    title: 'Season Window',
    description: 'June 3 – August 14 · Tue & Wed nights'
  },
  {
    icon: '📍',
    title: 'Match Site',
    description: 'Green Island Park · 13 outdoor courts'
  },
  {
    icon: '💵',
    title: 'Player Fee',
    description: '$25 per roster slot · covers balls & courts'
  }
];
  ...
  return (
    <div className="rules-page">
      <div className="rules-header">
        ...
        <p>La Crosse Team Tennis Association · Updated April 16, 2025</p>
      </div>
