...
async function loadTeamData(scheduleUrl, rosterUrl) {
  ...
  try {
    ...
    const icsPath = scheduleData.teamIcsPath || `/teams/${scheduleData.night}/ics/${scheduleData.team.replace(/\s+/g, '_')}/team.ics`;
    document.getElementById('add-all-ics').href = sanitizeUrl(icsPath);
